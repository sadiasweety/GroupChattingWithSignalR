...
using AutoMapper;
using GroupChatEvidence.Data;
using GroupChatEvidence.Hubs;
using GroupChatEvidence.Models;
using GroupChatEvidence.ViewModels;
...
namespace GroupChatEvidence.Controllers
{
